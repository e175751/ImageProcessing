...
\bibitem{book1} Python版OpenCVで写真を漫画風に加工: http://opencv.blog.jp/python/manga\_camera
\bibitem{book2} 漫画風の画像に変換: http://authorunknown408.blog.fc2.com/blog-entry-35.html
\end{thebibliography}
\end{document}
